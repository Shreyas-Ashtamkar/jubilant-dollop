...
# detect from webcam
def detect_realtime( Yolo, output_path, video_path=0, input_size=416, show=False, CLASSES=YOLO_COCO_CLASSES, score_threshold=0.3, iou_threshold=0.45, rectangle_colors=''):
    # times = []
    vid = cv2.VideoCapture(video_path)
